...
function Cards() {
  return (
    <section>
      ...
      <div id='card' className='container flex flex-col md:flex-row items-center  mx-auto my-6 space-y-0 md:space-y-0 gap-6 md:grid md:grid-cols-2 lg:flex '>

        <div className='border-2 border-card-border rounded-lg   lg:mx-2'>
          <div className='px-5 py-4'>
          <img src={BlueR } alt="" />
             <div>
                <p className=' text-xs py-1'>Desert king <span className='pl-28 lg:pl-16 font-semibold'>BT per night</span></p>
